...
from keypad_test.Sprites import KEYPAD_UP, KEYPAD_UP_INVERT, KEYPAD_RIGHT, KEYPAD_RIGHT_INVERT, KEYPAD_DOWN, KEYPAD_DOWN_INVERT, KEYPAD_LEFT, KEYPAD_LEFT_INVERT, KEYPAD_A, KEYPAD_A_INVERT, KEYPAD_B, KEYPAD_B_INVERT
